...
class Main
{
    ...
    {
        val reflection = Reflections("eu.elfring.adventofcode2023.days")
        val toRegister2023 = reflection.getSubTypesOf(AoCPuzzle::class.java)
            .map { it.constructors.first().newInstance() as AoCPuzzle }.toList()

        toRegister2023.forEach { puzzles[it.day] = it }
    }
}
